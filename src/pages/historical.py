...
layout = html.Div(
 ...
 #                                                             {'label': 'US session', 'value': 'opt3'}
                ...
                dbc.Col([
                        ...
                        dbc.Col(create_titled_card('KPI',
                                                   html.Div([
                                                       dbc.Row([
                                                           ...
                                                           dbc.Col([                                
                                                               dbc.Card([
                                                                   html.H3(id = 'histperf', style = {'color':colors_config['colors']['palet'][4], 'margin-left':'10px'}, className='responsive-card-value'),
                                                               ...
                                                               html.Br(),
                                                               dbc.Card([
                                                                   html.H3(id = 'histwinrate', style = {'color':colors_config['colors']['palet'][4], 'margin-left':'10px'}, className='responsive-card-value'),
                                                           ...
                                                           dbc.Col([
                                                               dbc.Card([
                                                                   html.H3(id = 'histsharpe', style = {'color':colors_config['colors']['palet'][4], 'margin-left':'10px'}, className='responsive-card-value'),
                                                                   html.H6('Sharpe Ratio', style={'color':'#FFFFFF', 'margin-left':'10px'}, className='responsive-card-text'),
                                                                   html.Br(),
                                                                   ], style = kpi_style),
                                                               html.Br(),
                                                               dbc.Card([
                                                                   html.H3(id = 'histwindays', style = {'color':colors_config['colors']['palet'][4], 'margin-left':'10px'}, className='responsive-card-value'),
                                                           ...
                                                           dbc.Col([
                                                               dbc.Card([
                                                                   html.H3(id = 'histpr', style = {'color':colors_config['colors']['palet'][4], 'margin-left':'10px'}, className='responsive-card-value'),
                                                                   html.H6('Profit Ratio', style={'color':'#FFFFFF', 'margin-left':'10px'}, className='responsive-card-text'),
                                                                   html.Br(),
                                                                   ], style = kpi_style),
                                                               html.Br(),
                                                               dbc.Card([
                                                                   html.H3(id = 'histwinmonths', style = {'color':colors_config['colors']['palet'][4], 'margin-left':'10px'}, className='responsive-card-value'),
                                                                   html.H6('% Winning Months', style={'color':'#FFFFFF', 'margin-left':'10px'}, className='responsive-card-text'),
                                                                   ], style = kpi_style),
                                                               ], width = 2),
                                                           dbc.Col([
                                                               dbc.Card([
                                                                   html.H3(id = 'histdd', style = {'color':colors_config['colors']['palet'][4], 'margin-left':'10px'}, className='responsive-card-value'),
                                                                   html.H6('Max DrawDown', style={'color':'#FFFFFF', 'margin-left':'10px'}, className='responsive-card-text'),
                                                                   html.Br(),
                                                                   ], style = kpi_style),
                                                               html.Br(),
                                                               dbc.Card([
                                                                   html.H3(id = 'histbestday', style = {'color':colors_config['colors']['palet'][4], 'margin-left':'10px'}, className='responsive-card-value'),
                                                           ...
                                                           dbc.Col([
                                                               dbc.Card([
                                                                   html.H3(id = 'histtrades', style = {'color':colors_config['colors']['palet'][4], 'margin-left':'10px'}, className='responsive-card-value'),
                                                                   html.H6('Avg Trades per day', style={'color':'#FFFFFF', 'margin-left':'10px'}, className='responsive-card-text'),
                                                                   ], style = kpi_style),
                                                               html.Br(),
                                                               dbc.Card([
                                                                   html.H3(id = 'histworstday', style = {'color':colors_config['colors']['palet'][4], 'margin-left':'10px'}, className='responsive-card-value'),
                    ...
                    html.Br(),
                    dbc.Row([
                        dbc.Col(create_titled_card('YTD Performance', dcc.Graph(id='histgraph-1', figure = {}), card_title_img),  xs=12, sm=12, md=7, lg=7, xl=7),
                        dbc.Col(create_titled_card('Performance Targets', dcc.Graph(id= 'histgraph-gauge', figure = {}), card_title_img),  xs=12, sm=12, md=5, lg=5, xl=5),
                        ])
                    
                    ],  xs=12, sm=12, md=7, lg=7, xl=7),
                dbc.Col([
                    create_titled_card('Weekly performance', dcc.Graph(id='histgraph-2', figure = {}, style={'height':'100%'}), card_title_img, height='21rem'),
                    html.Br(),
                    create_titled_card('Last 20 Tradingdays performance', dcc.Graph(id='histgraph-3', figure = {}), card_title_img),                         
...
@callback(
     [
     Output('histgraph-1', 'figure'),
     Output('histperf', 'children'),
     Output('histwinrate', 'children'),
     Output('histwindays', 'children'),
     Output('histwinmonths', 'children'),
     Output('histtrades', 'children'),
     Output('histsharpe', 'children'),
     Output('histpr', 'children'),
     Output('histdd', 'children'),
     Output('histbestday', 'children'),
     Output('histworstday', 'children'),
     Output('histgraph-2', 'figure'),
     Output('histgraph-3', 'figure'),
     Output('histtable-1', 'data'),
     Output('histgraph-gauge', 'figure'),
     ],
     [
...
def update_page1(selected_stop, selected_cost, selected_slip, selected_period):
    ...
    slip = selected_slip/(2500)  # divided by value of 1 nasdaq future 
