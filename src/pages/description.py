            ...
            dbc.Col([
                create_titled_card('DashBoard Interactivity',
                                   html.Div([
                                       ...
                                       html.P("Unfortunately trading comes with a cost. Exchange fees, broker commissions etc.",
                                              className='card-text',
                                              style={'color': '#95D7E0'}),
                                       html.Hr(),
                                       ...
                                       html.P("There is never a guarantee the execution price is exactly as intented. The slippage is the mismatch between the intended and the actual executed price. Ethereum has less volume traded than BitCoin and can be quite volatile, hence slippage is to be expected.",
                                              className='card-text',
                                              style={'color': '#95D7E0'}),
                                       ]),
